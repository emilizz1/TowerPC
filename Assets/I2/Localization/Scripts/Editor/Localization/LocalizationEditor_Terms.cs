...
namespace I2.Loc
{
	public partial class LocalizationEditor
	{
		...
		void OnGUI_KeysList(bool AllowExpandKey = true, float Height = 300.0f, bool ShowTools=true)
		{
			...
			if (UnityEngine.Event.current!=null && UnityEngine.Event.current.type == UnityEngine.EventType.Layout)
			...
			if (mShowableTerms.Count == 0 && UnityEngine.Event.current.type == UnityEngine.EventType.Layout)
