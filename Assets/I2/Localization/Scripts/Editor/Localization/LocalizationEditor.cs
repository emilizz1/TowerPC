...
namespace I2.Loc
{
	public partial class LocalizationEditor
	{
		...
		void OnGUI_References()
		{
            ...
            bool canTest = UnityEngine.Event.current.type == UnityEngine.EventType.Repaint;
        ...
        {
            return mTestAction == testType && UnityEngine.Event.current.type == UnityEngine.EventType.Repaint;
        }
        static bool TestButton(eTest_ActionType action, string text, GUIStyle style, params GUILayoutOption[] options)
        {
            return GUILayout.Button(text, style, options) || mTestAction == action && UnityEngine.Event.current.type == UnityEngine.EventType.Repaint;
        }

        static bool TestButtonArg(eTest_ActionType action, object arg, string text, GUIStyle style, params GUILayoutOption[] options)
        {
            return GUILayout.Button(text, style, options) || mTestAction == action && (mTestActionArg==null || mTestActionArg.Equals(arg)) && UnityEngine.Event.current.type == UnityEngine.EventType.Repaint;
        }
